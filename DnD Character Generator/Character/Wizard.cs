...
class Wizard : ICharacter
{
    ...
    private string Race;
    private string Name;
    private string charClass = "Wizard";

    public Wizard(Load character)
    {
    ...
    public void SetTraitsandProf(ListView traits, ListView prof, ListView equipment)
    {
        ...
        traits.Items.Add("Arcane Tradition");
        prof.Items.Add("Armor: None");
        prof.Items.Add("Weapons: Daggers, Darts,, Slings, Quarterstaffs, Light crossbows");
        prof.Items.Add("Tools: None");
        prof.Items.Add("Saving Throws: Intelligence, Wisdom");
        prof.Items.Add("Skills: Choose two from Arcana, History, Insight, Investigation, Medicine, and Religion");
        equipment.Items.Add("(A) Quarterstaff or (B) Dagger");
        equipment.Items.Add("(A) Component pouch or (B) Arcane focus");
        equipment.Items.Add("(A) Scholar's pack or (B) Explorer's pack");
        equipment.Items.Add("A Spellbook");
        switch (Race)
        {
            case "Dwarf":
    ...
    public void SaveCharacter(SaveFileDialog saveDialog)
    {
        ...
        using (BinaryWriter writer = new BinaryWriter(output))
        {
            ...
            MessageBox.Show("Wizard saved at " + saveDialog.FileName);
        }
    }
}
