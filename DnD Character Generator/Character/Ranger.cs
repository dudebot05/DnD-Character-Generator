...
class Ranger : ICharacter
{
    ...
    private string Race;
    private string Name;
    private string charClass = "Ranger";

    public Ranger(Load character)
    {
    ...
    {
        traits.Items.Add("Favored Enemy");
        traits.Items.Add("Natural Explorer");
        prof.Items.Add("Armor: Light armor, Medium armor, Shields");
        prof.Items.Add("Weapons: Simple weapons, Martial weapons");
        prof.Items.Add("Tools: None");
        prof.Items.Add("Saving Throws: Strength, Dexterity");
        prof.Items.Add("Skills: Choose three from Animal Handling, Athletics, Insight, Investigation, Nature, Perception, Stealth, and Survival");
        equipment.Items.Add("(A) Scale mail or (B) Leather armor");
        equipment.Items.Add("(A) Two Shortswords or (B) Two Simple melee weapons");
        equipment.Items.Add("(A) Dungeoneer's pack or (B) Explorer's pack");
        equipment.Items.Add("Longbow and 20 arrows");
        switch (Race)
        {
            case "Dwarf":
    ...
    public void SaveCharacter(SaveFileDialog saveDialog)
    {
        ...
        using (BinaryWriter writer = new BinaryWriter(output))
        {
            ...
            MessageBox.Show("Ranger saved at " + saveDialog.FileName);
        }
    }
}
