...
class Paladin : ICharacter
{
    ...
    private string Race;
    private string Name;
    private string charClass = "Paladin";
    ...
    {
        traits.Items.Add("Divine Sense");
        traits.Items.Add("Lay on Hands");
        ...
        prof.Items.Add("Skills: Choose two from Athletics, Insight, Intimidation, Medicine, Persuasion, and Religion");
        equipment.Items.Add("(A) Martial weapon and Shield or (B) Two Martial Weapons");
        equipment.Items.Add("(A) Five Javelins or (B) Any Simple melee weapon");
        equipment.Items.Add("(A) Priest's pack or (B) Explorer's pack");
        equipment.Items.Add("Chain mail and a Holy symbol");
        switch (Race)
        {
            case "Dwarf":
