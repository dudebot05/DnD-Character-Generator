...
class Fighter : ICharacter
{
    ...
    {
        traits.Items.Add("Fighting Style");
        traits.Items.Add("Second Wind");
        prof.Items.Add("Armor: All armor, Shields");
        prof.Items.Add("Weapons: Simple weapons, Martial weapons");
        prof.Items.Add("Tools: None");
        prof.Items.Add("Saving Throws: Strength, Constitution");
        prof.Items.Add("Skills: Choose two from Acrobatics, Animal Handling, Athletics, History, Insight, Intimidation, Perception, and Survival");
        equipment.Items.Add("(A) Chain mail or (B) Leather, Longbow and 20 arrows");
        equipment.Items.Add("(A) Martial weapon and Shield or (B) Two Martial weapons");
        equipment.Items.Add("(A) Light crossbow and 20 bolts or (B) Two Handaxes");
