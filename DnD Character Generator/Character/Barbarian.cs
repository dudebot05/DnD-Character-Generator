...
class Barbarian : ICharacter
{
    ...
    public void SetTraitsandProf(ListView traits, ListView prof, ListView equipment)
    {
        ...
        prof.Items.Add("Skills: Choose two from Animal Handling, Athletics, Intimidation, Nature, Perception and Survival");
        equipment.Items.Add("(A) Greataxe or (B) Any Martial melee weapon");
        equipment.Items.Add("(A) Two Handaxes or (B) Any Simple weapon");
        equipment.Items.Add("An explorer's pack and four javelins");
        switch (Race)
        {
            case "Dwarf":
