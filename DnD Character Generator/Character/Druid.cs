...
class Druid : ICharacter
{
    ...
    private string Race;
    private string Name;
    private string charClass = "Druid";

    public Druid(Load character)
    {
    ...
    {
        traits.Items.Add("Druidic");
        traits.Items.Add("Spellcasting");
        prof.Items.Add("Armor: Light armor, Medium armor, Shields (cannot be made of metal)");
        prof.Items.Add("Weapons: Clubs, Daggers, Darts, Javelins, Maces, Quarterstaffs, Scimitars, Sickles, Slings, Spears");
        prof.Items.Add("Tools: Herbalism kit");
        prof.Items.Add("Saving Throws: Intelligence, Wisdom");
        prof.Items.Add("Skills: Choose two from Arcana, Animal Handling, Insight, Medicine, Nature, Perception, Religion, and Survival");
        equipment.Items.Add("(A) Wooden shield or (B) Any Simple weapon");
        equipment.Items.Add("(A) Scimitar (B) Any Simple melee wapon");
        equipment.Items.Add("Leather armor, an explorer's pack, and a druidic focus");
        switch (Race)
        {
            case "Dwarf":
    ...
    public void SaveCharacter(SaveFileDialog saveDialog)
    {
        ...
        using (BinaryWriter writer = new BinaryWriter(output))
        {
            ...
            MessageBox.Show("Druid saved at " + saveDialog.FileName);
        }
    }
}
