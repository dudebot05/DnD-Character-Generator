...
class Warlock : ICharacter
{
    ...
    private string Race;
    private string Name;
    private string charClass = "Warlock";

    public Warlock(Load character)
    {
    ...
    {
        traits.Items.Add("Otherworldly Patron");
        traits.Items.Add("Pact Magic");
        prof.Items.Add("Armor: Light armor");
        prof.Items.Add("Weapons: Simple weapons");
        prof.Items.Add("Tools: None");
        prof.Items.Add("Saving Throws: Wisdom, Charisma");
        prof.Items.Add("Skills: Choose two from Arcana, Deception, History, Intimidation, Investigation, Nature, and Religion");
        ...
        equipment.Items.Add("(A) Scholar's pack or (B) Dungeoneer's pack");
        equipment.Items.Add("Leather armor, Any Simple weapon, and Two Daggers");
        switch (Race)
        {
            case "Dwarf":
    ...
    public void SaveCharacter(SaveFileDialog saveDialog)
    {
        ...
        using (BinaryWriter writer = new BinaryWriter(output))
        {
            ...
            MessageBox.Show("Warlock saved at " + saveDialog.FileName);
        }
    }
}
