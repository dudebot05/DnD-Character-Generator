...
class Sorcerer : ICharacter
{
    ...
    public void SetTraitsandProf(ListView traits, ListView prof, ListView equipment)
    {
        ...
        traits.Items.Add("Sorcerous Origin");
        ...
        prof.Items.Add("Saving Throws: Constitution, Charisma");
        prof.Items.Add("Skills: Choose two from Arcana, Deception, Insight, Intimidation, Persuasion, and Religion");
        ...
        equipment.Items.Add("Two Daggers");
        switch (Race)
        {
            case "Dwarf":
    ...
    public void SaveCharacter(SaveFileDialog saveDialog)
    {
        ...
        using (BinaryWriter writer = new BinaryWriter(output))
        {
            ...
            MessageBox.Show("Sorcerer saved at " + saveDialog.FileName);
        }
    }
}
